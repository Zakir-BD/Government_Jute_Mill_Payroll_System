...
app.controller('DesignationController', ['$scope', 'Designation', function ($scope, Designation) {
        var ob = this;
        ob.objArray = [];
        ...
        ob.editObject = function (id) {
            ...
            ob.obj = Designation.get({designationId: id}, function () {
                ob.flag = 'edit';
            });
        };
        ob.updateObjectDetail = function () {
            ...
            if ($scope.objForm.$valid) {
                ob.obj.$updateObject(function (object) {
                    console.log(object);
                    ob.updatedId = object.designationId;
                    ob.reset();
                    ob.flag = 'updated';
                    ob.fetchAllObject();
                });
        ...
        ob.deleteObject = function (id) {
            ...
            ob.obj = Designation.delete({designationId: id}, function () {
                ob.reset();
                ob.flag = 'deleted';
                ob.fetchAllObject();
            });
