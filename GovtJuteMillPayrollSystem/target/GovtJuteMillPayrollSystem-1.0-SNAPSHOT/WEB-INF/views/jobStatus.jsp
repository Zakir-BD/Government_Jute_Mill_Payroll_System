...
<html lang="en-US">
    <head>
        <meta charset="UTF-8" /> 
        <title>${pageContext.request.contextPath}_JobStatus </title>
        ...
        <script src="${pageContext.request.contextPath}/static/js/controller/jobStatus_controller.js"></script>


    </head>
    <body ng-app="myApp">
        <div ng-controller="JobStatusController as objCtrl">
            <div class="container">
                <div class="row">
                    <!--Header-->
                            ...
                            <div class="content col-md-10">
                                <form name="objForm" method="POST">
                                    <table>
                                        <tr>
                                            <td colspan="2">
                                                <h1> JobStatus Information</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <div ng-if="objCtrl.flag != 'edit'">
                                                    <h3> Add New JobStatus </h3> 
                                                </div>
                                                <div ng-if="objCtrl.flag == 'edit'">
                                                    <h3> Update JobStatus for ID: {{ objCtrl.obj.jobStatusId}} </h3> 
                                                </div> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>JobStatus Code: </td> <td><input type="text" name="jobStatusCd" ng-model="objCtrl.obj.jobStatusCd" required/> 
                                                <span ng-show="objForm.jobStatusCd.$error.required" class="msg-val">*</span> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>JobStatus Name: </td> <td> <input type="text" name="jobStatusName" ng-model="objCtrl.obj.jobStatusName" required/> 
                                                <span ng-show="objForm.jobStatusName.$error.required" class="msg-val">*</span> 
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="2"> <span ng-if="objCtrl.flag == 'created'" class="msg-success">*</span>
                                                <span ng-if="objCtrl.flag == 'failed'" class="msg-val">JobStatus already exists.</span> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="2">
                                                <div ng-if="objCtrl.flag != 'edit'">
                                                    <input  type="submit" ng-click="objCtrl.addObject()" value="Add JobStatus"/> 
                                                    <input type="button" ng-click="objCtrl.reset()" value="Reset"/>
                                                </div>
                                                <div ng-if="objCtrl.flag == 'edit'">
                                                    <input  type="submit" ng-click="objCtrl.updateObjectDetail()" value="Update JobStatus"/> 	
                                ...
                                <table>
                                    <tr><th>JobStatus Code </th> <th> JobStatus Name</th></tr>
                                    <tr ng-repeat="row in objCtrl.objArray| orderBy: 'jobStatusCd'">
                                        <td><span ng-bind="row.jobStatusCd"></span></td>
                                        <td><span ng-bind="row.jobStatusName"></span></td>
                                        <td>
                                            <input type="button" ng-click="objCtrl.deleteObject(row.jobStatusId)" value="Delete"/>
                                            <input type="button" ng-click="objCtrl.editObject(row.jobStatusId)" value="Edit"/>
                                            <span ng-if="objCtrl.flag == 'updated' && row.jobStatusId == objCtrl.updatedId" class="msg-success">Updated.</span>
                                        </td> 
                                    </tr>	
                                </table>
                            </div>
